...
genai.configure(api_key=os.getenv("_KEY"))
...
SYSTEM_PROMPT = """You are a helpful assistant. Answer the question ONLY using the provided context. If the answer isn't there, say you don't know. Always cite the filename and page numbers used."""
