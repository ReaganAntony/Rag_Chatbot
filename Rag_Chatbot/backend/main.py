...
DATA_DIR = Path("./Rag_Chatbot/data")
...
async def upload_document(
    ...
    try:
        ...
        # Step 7: Save document metadata to JSON file
        doc_data = {
...
async def delete_document(doc_id: str):
    ...
    Returns:
        Success message.
    """
    from core.storage import delete_document_chunks
    ...
    file_path = DATA_DIR / doc_to_delete["filename"]
    if file_path.exists():
        os.remove(file_path)
